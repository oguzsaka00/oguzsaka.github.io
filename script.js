...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const projectData = {
        ...
        "investment-analysis": {
            ...
            title:
                "Yapay Zeka Destekli Yatırım Analiz Platformu",
            ...
            description:
                "Türk borsası (BIST) hisselerini gerçek zamanlı olarak takip eden, yapay zeka destekli teknik ve temel analiz sunan, portföy yönetimi ile AI sohbet asistanı içeren tam kapsamlı web tabanlı yatırım analiz platformu. Kullanıcılar hisse senedi fiyatlarını anlık olarak takip edebilir ve AI destekli yorum alabilir.",


            purpose:
                "Bireysel yatırımcıların hisse senedi analizini daha bilinçli ve veriye dayalı yapabilmesini sağlamak; yapay zeka teknolojilerini gerçek finansal verilere entegre ederek anlamlı bir full-stack proje geliştirmek.",
            ...
            features: [
                ...
                "Gerçek zamanlı BIST hisse takibi",

                "Yapay zeka destekli hisse analizi ve yorumu",

                "AI sohbet asistanı (hisseye özel bağlam)",

                "Portföy yönetimi paneli",

                "Dinamik kâr/zarar hesaplama",

                "Kullanıcı kayıt ve giriş sistemi (JWT)",

                "Kullanıcıya bağlı portföy",
